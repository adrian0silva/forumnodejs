...
__decorate([
    ...
    (0, required_roles_decorator_1.RequiredRoles)(client_1.Roles.ADMIN, client_1.Roles.MODERATOR, client_1.Roles.USER),
    (0, common_1.Patch)(':id'),
...
__decorate([
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard, role_guard_1.RoleGuard),
    (0, required_roles_decorator_1.RequiredRoles)(client_1.Roles.ADMIN),
